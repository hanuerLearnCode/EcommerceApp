                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="preview-list">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{asset('admin/assets/images/faces/face8.jpg')}}" alt="image"
                                         class="rounded-circle"/>
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{asset('admin/assets/images/faces/face9.jpg')}}" alt="image"
                                         class="rounded-circle"/>
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{asset('admin/assets/images/faces/face11.jpg')}}" alt="image"
                                         class="rounded-circle"/>
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
